...
const Rank = () => {
  return (
    <section className="sm:w-[100%] md:w-[49.25%] h-full border border-solid border-basicGrey/30 rounded-md bg-white">
      <h2 className="px-3 py-2 font-bold text-[0.9rem]">랭킹</h2>
